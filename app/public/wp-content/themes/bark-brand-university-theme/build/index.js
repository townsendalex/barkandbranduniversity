...
class MyNotes {
  ...
  editNote(e) {
    var thisNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li");
    if (thisNote.data("state") == "edit-mode") {
      this.noteReadOnly(thisNote);
    } else {
      this.noteEditMode(thisNote);
    }
  }
  noteEditMode(thisNote) {
    thisNote.find(".edit-note").html('<i class="fa fa-times" aria-hidden="true"></i> Cancel');
    thisNote.find(".note-title-field, .note-body-field").removeAttr("readonly").addClass("note-active-field");
    thisNote.find(".update-note").addClass("update-note--visible");
    thisNote.data("state", "edit-mode");
  }
      ...
      this.resultsDiv.innerHTML = `
        <div class="row">
          <div class="one-third">
            ...
            ${results.generalInfo.length ? '<ul class="link-list min-list">' : "<p>Search retured 0 entries.</p>"}
              ${results.generalInfo.map(item => `<li><a href="${item.permalink}">${item.title}</a> ${item.postType == "post" ? `by ${item.authorName}` : ""}</li>`).join("")}
            ${results.generalInfo.length ? "</ul>" : ""}
          </div>
          <div class="one-third">
            <h2 class="search-overlay__section-title">Programs</h2>
            ${results.programs.length ? '<ul class="link-list min-list">' : `<p>Search retured 0 entries. <a href="${universityData.root_url}/programs">View all programs</a></p>`}
              ${results.programs.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join("")}
            ${results.programs.length ? "</ul>" : ""}

            <h2 class="search-overlay__section-title">Professors</h2>
            ${results.professors.length ? '<ul class="professor-cards">' : `<p>Search retured 0 entries.</p>`}
          ...
          <div class="one-third">
            ...
            ${results.campuses.length ? '<ul class="link-list min-list">' : `<p>Search retured 0 entries. <a href="${universityData.root_url}/campuses">View all campuses</a></p>`}
              ${results.campuses.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join("")}
            ${results.campuses.length ? "</ul>" : ""}

            <h2 class="search-overlay__section-title">Events</h2>
            ${results.events.length ? "" : `<p>Search retured 0 entries. <a href="${universityData.root_url}/events">View all events</a></p>`}
              ${results.events.map(item => `
                <div class="event-summary">
                  ...
                  <div class="event-summary__content">
                    ...
                    <p>${item.summary} <a href="${item.permalink}" class="nu gray">Learn more</a></p>
                  </div>
                </div>
              `).join("")}
      ...
      <div class="search-overlay">
        <div class="search-overlay__top">
          <div class="container">
            ...
            <input type="text" class="search-term" placeholder="What are you sniffing for?" id="search-term">
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkbark_brand_university_theme"] = globalThis["webpackChunkbark_brand_university_theme"] || [];

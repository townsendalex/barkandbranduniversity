    ...
    <div class="metabox metabox--position-up metabox--with-home-link">
        ...
        <?php
          ...
          if ($relatedProfessors->have_posts()) {
              ...
              echo '<h4 class="headline headline--medium-small">' . get_the_title() . ' Professors</h4>';
          ...
          // Program Events
            ...
            if ($programEvents->have_posts()) {
                ...
                echo '<hr class="section-break">';
                echo '<h2 class="headline headline--medium-small">Upcoming ' . get_the_title() . ' Events</h2>';
            ...
            if ($relatedCampuses) {
                echo '<hr class="section-break">';
                echo '<h2 class="headline headline--medium-small">' . get_the_title() . ' is available at these campuses:</h2>';
